...
var validator;
var form = $('#addFinanceFormPayment');
	...
	validator = form
			.validate({
				...
				errorPlacement : function(error, element) { // render error
															// placement
					if (element.attr("name") == "payment1") {
						error.insertAfter("#paymentDiv");
...
$('#payment1', form).change(function() {
	$("#payment").val($(this).val().replace(/\,/g,"",""));

...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 项目管理<span class="c-gray en">&gt;</span> 添加项目经理</nav>
<div class="page-container">
   <div class="porlet box blur">
      <div class="portlet-title">
			<div class="caption">
				<i class="Hui-iconfont"> &#xe667;</i> <span>添加项目经理</span>
			</div>
		</div>
		<form class="form form-horizontal" id="addProjectForm" style="line-height: 40px;margin-bottom: 15px;">
			<div class="row cl">
...
<script type="text/javascript" src="../../js/projectManager/addProjectManager.js"></script>
</body>
</html>
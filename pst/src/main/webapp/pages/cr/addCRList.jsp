...
<div class="page-container">
    <div class="porlet box blur">
		...
		<form class="form form-horizontal" id="addCRForm" enctype="multipart/form-data" style="margin-bottom: 15px;">
		    <input type="hidden" placeholder="" value="${param.projectId }" id="addProjectId" name="addProjectId" />
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>需求描述：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="addCRDescribe" name="addCRDescribe" style="width:25%;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>预估（小时）：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="addEstimatedWorkload" name="addEstimatedWorkload" style="width:25%;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>提交人：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="addPresenter" name="addPresenter" style="width:25%;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>确认人：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder="" id="addConfirmor" name="addConfirmor" style="width:25%;">
				</div>
			</div>
			<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>报价：</label>
					<div class="formControls col-xs-8 col-sm-9">
					    <span id="addConfirmQuotationDiv">
						    <span class="add-on">￥</span>
							<input type="text" class="input-text" placeholder="" id="addConfirmQuotation1" name="addConfirmQuotation1" style="width:13%;;margin-left:-4px;margin-top: -5px;border-left:0px;" onblur="formatNumber(this)" >
						</span>
						<input type="hidden" id="addConfirmQuotation" name="addConfirmQuotation"/>
					</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><a title="单个附件大小请不要超过5M" style="text-decoration:none;"><i class="Hui-iconfont">&#xe633;</i></a>附件：</label>
				<div class="formControls col-xs-8 col-sm-9"> 
...
<script type="text/javascript" src="js/requirement/addCRList.js"></script>

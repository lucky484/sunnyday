   ...
   <div class="porlet box blur">
      <div class="portlet-title">
		...
		<form class="form form-horizontal" style="line-height: 40px;margin-bottom: 60px;margin-left:20px;">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${im.name }" disabled="true" placeholder="" id="name" name="name" style="width:50%;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮箱：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${im.email }" disabled="true" placeholder="" id="email" name="email" style="width:50%;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>电话：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${im.phone }" disabled="true" placeholder="" id="phone" name="phone" style="width:50%;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>添加时间：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value='<fmt:formatDate value="${im.createTime }" type="date" pattern="yyyy-MM-dd" />' disabled="true" placeholder="" id="createTime" name="createTime" style="width:50%;">
				</div>
			</div>
			<c:if test="${sessionScope.user.role.roleName=='general_manager' or sessionScope.user.role.roleName=='admin' or sessionScope.user.userId == pm.creatorId}">
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
						<a href="edit.do?projectManagerId=${im.implementManagerId}" class="btn btn-primary" type="button"><i class="Hui-iconfont">&#xe60c;</i> 编辑</a>
					</div>
				</div>
			 </c:if>
		</form>
		...
		<div class="" style="margin-bottom:100px;margin-left:20px;margin-top:20px;">
			...
			<form id="addImplementManagerCommentForm">
				<input type="hidden" value="${im.implementManagerId}" id="implementManagerId" name="implementManagerId" />
				<div class="">
...
<script type="text/javascript" src="../../js/implementManager/viewImplementManager.js"></script>
</body>
</html>
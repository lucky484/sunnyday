...
<span style="float:right;"><a href="addImplementManager.do" class="btn btn-primary"><i class="Hui-iconfont"></i> 新增</a>
<a href="javascript:;" class="btn btn-success"><i class="Hui-iconfont">&#xe644;</i> 导出Excle</a></span>
</div>
<div class="page-container">
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort"" id="implementManager" width="100%">
			<thead>
				<tr class='text-c'>
					<th>创建时间</th>
					<th>姓名</th>
...
<script type="text/javascript" src="../../js/implementManager/implementManagerList.js"></script>

...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i> <span class="hidden-480">添加机会管理</span>
								</div>
							</div>
							<div class="portlet-body form">
								<br />
								<!-- BEGIN FORM-->
								<form id="addChanceManage" class="form-horizontal"
											...
											<div class="controls">
												<div id="forecastQuotationDiv"
													...
													<span class="add-on">￥</span> <input type="text"
														placeholder="" id="forecastQuotation1"
    ...
    <script type="text/javascript" src="js/chanceManage/addChanceManage.js"></script>

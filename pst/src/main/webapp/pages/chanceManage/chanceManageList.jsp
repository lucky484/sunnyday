...
<body class="page-header-fixed">
					...
					<div class="span12">
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-table"></i>机会管理列表
								</div>
								<div class="actions">
									
									    <a href="projectsManagement/chanceManage/addChanceManage.do"
										class="btn blue"><i class="icon-plus"></i> 新增</a>
									<c:if test="${fn:contains(sessionScope.authorities, 'chanceManage_export')}">
										<a href="projectsManagement/chanceManage/export.do"
											class="btn green"><i class="icon-file"></i> 导出Excel</a>
									</c:if>
								</div>
							</div>
							<div class="portlet-body">
								<table id="chanceManage"
								...
								<div id="deleteConfirm" class="modal fade" tabindex="-1"
									...
									<div class="modal-footer">
										...
										<button data-dismiss="modal" class="btn blue"
											id="deleteChanceManage">确定</button>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="js/chanceManage/chanceManageList.js"></script>
	<!-- END BODY -->
</body>
</html>
...
<body class="page-header-fixed">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<br />
						<ul class="breadcrumb">
							<li><a href="projectsManagement/outsourcingManage/outsourcingManage.do">外包管理</a>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i> <span class="hidden-480">外包管理更新</span>
								</div>
							</div>
							<div class="portlet-body form">
								<br />
								<!-- BEGIN FORM-->
								<form id="editOutsourcingManageForm" class="form-horizontal"
									enctype="multipart/form-data">
									<input type="hidden" id="outsourcingManageId" name="outsourcingManageId" value="${om.outsourcingManageId}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="" id="name"
												...
												value="${om.name }" /> <span class="help-inline"></span>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="" id="email"
												...
												value="${om.email }" /> <span class="help-inline"></span>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" placeholder="" id="phone"
												...
												value="${om.phone }" /> <span class="help-inline"></span>
										</div>
									</div>
	...
	<script type="text/javascript" src="js/outsourcingManage/editOutsourcingManage.js"></script>

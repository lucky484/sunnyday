...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="icon-reorder"></i> <span class="hidden-480">添加项目收款</span>
								</div>
							</div>
							<div class="portlet-body form">
								<br />
								<!-- BEGIN FORM-->
								<form id="addFinanceFormReceive" class="form-horizontal">
										...
										<div class="controls">
											<div id="receiveDiv"
												...
												<span class="add-on">￥</span> <input type="text"
													placeholder="" id="receive1" 
													name="receive1" class="m-wrap" value="" onblur="formatNumber(this)"/>
											</div>
										</div>
	...
	<script type="text/javascript" src="js/finance/addFinanceReceive.js"></script>

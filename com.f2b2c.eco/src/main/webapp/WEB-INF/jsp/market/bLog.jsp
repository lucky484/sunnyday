...
<head>  
 ...
 <%--  <link href="${bootstrapCss}" rel="stylesheet" /> --%>
  ...
  <spring:url value="/resources/market/img/help/log2.png" var="logUrl"/>
  <spring:url value="/resources/market/img/help/ter.png" var="terUrl"/>
...
<body>
	<div class="">
		<div class="title">
			<img class="title-img" src="${logUrl }" />
			<span class="title-span">物流配送</span>
	...
	<div class="">
		<div class="title">
			<img class="title-img" src="${terUrl }" />
			<span class="title-span">售后咨询</span>
			<img class="float_r" alt="" src="${moreUrl}" width="20px" height="5px">
		</div>
		<c:forEach items="${model }" var="model">

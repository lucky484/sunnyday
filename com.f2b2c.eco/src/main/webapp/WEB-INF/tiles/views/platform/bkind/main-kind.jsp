...
<spring:url value="/farm/bkind/new" var="newKindUrl"/>
            ...
            <div class="col-sm-8">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <a data-toggle="modal" onclick="newKind()" class="btn btn-primary " id="addKindModal">新增B端分类</a>
                    </div>
                    <div class="ibox-content">
	                                ...
	                                <div class="modal-body cleanfix">
											...
											<div class="form-group">
												<div class="col-md-12">
													...
													placeholder="添加点备注吧。。。"  maxlength="40">
												</div>
											</div>
											<div class="form-group" id="imgIsHide1">
												
											</div>
											<div class="form-group" id="imgIsHide2">

											</div>
											<div class="form-group" id="isCommission">

...
<spring:url value="/farm/bwap/querypage" var="queryUrl" />
<spring:url value="/farm/bwap/del" var="delUrl" />
<spring:url value="/farm/bwap/addpage" var="bwapAddPageUrl" />
<script>
$(function(){
	$("#editable").dataTable({
		...
		"render" : function(data, type, full, row) {
				if(full){
					return '<img width="250px" height="80px" src="'+full.wapImgUrl+'"/>'
				}else{
					return '-'
				}
			}
...
function add(id){
	if(id !=null){
		window.location.href="${bwapAddPageUrl}?id="+id;
	}else{
		window.location.href="${bwapAddPageUrl}";
	}
}

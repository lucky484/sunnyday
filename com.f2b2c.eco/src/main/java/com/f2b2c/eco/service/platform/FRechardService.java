 ...
 *
 */
public interface FRechardService {
     ...
     * @return 返回余额变动记录
     */
    List<BUserBalanceRecordModel> getMyCommissionRechord(String userId,Integer start,Integer length);
     ...
     * @return 返回余额变动记录
     */
    List<BUserBalanceRecordModel> balanceRecord(String userId,Integer start,Integer length);
     ...
     * @return 返回充值记录信息
     */
    List<BRechardOrderModel> rechardRecord(String userId, Integer start, Integer length);
}
...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    ...
    $node.html([
    	      '<div id="insert-Image" class="modal-dialog" role="document">',
    	      '  <div class="modal-content">',
    	      (options.title ?
    	      '    <div class="modal-header">' +
    	      '      <button type="button" class="close" onclick="closeModal(this);" ><span aria-hidden="true" id="close2">&times;</span></button>' +

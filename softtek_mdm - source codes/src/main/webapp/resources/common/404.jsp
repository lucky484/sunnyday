    ...
    <div class="row m-n">
      <div class="col-sm-10 col-sm-offset-1">
        <div class="text-center m-b-lg">
          <h1 class="h text-white animated fadeInDownBig error_limit_visit">404</h1>
          	<h4 class="h text-white animated fadeInDownBig error_limit_visit">对不起，您所访问的页面不存在.</h4>
          	<c:choose>
          		<c:when test="${softtek_manager!=null}">
          			<spring:url value="/institution" var="homeUrl"/>
          		</c:when>
          		<c:otherwise>
          			<spring:url value="/customer" var="homeUrl"/>
          		</c:otherwise>
          	</c:choose>
          	<h3 class="h text-white animated fadeInDownBig gohome_page"><a href="${homeUrl}">返回首页</a></h3>
        </div>
      </div>
    </div>
  </section>

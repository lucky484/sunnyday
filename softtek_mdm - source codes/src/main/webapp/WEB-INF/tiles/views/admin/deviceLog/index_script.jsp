	    ...
	    function loadData()
	    {
	    	...
	    	var username = $("#username").val();
		  	  $('#deviceLog').dataTable({
					...
					"ajax" : {
						"url" : "deviceLog/queryAllDeviceLog",
						"dataSrc" : "data",
						"type" : "get",
						"data" : 
						{
					...
					"columnDefs" :[{
						 className: "col-lg-2 datatb-max-width-username", 
						"targets" : 0,
					...
					},
					{
						...
						render : function(data, type, full,meta) {
							...
							return '<div data-toggle="tooltip"  class="atip" data-placement="bottom" onMouseOver="$(this).tooltip('+"'show'"+')" data-title="'+full.deviceName+'"><span class="text-ellipsis">'+full.deviceName+'</span><div>';
						}
					...
					{
						className: "col-lg-3 datatb-max-width-devicelog",
						targets : [4],
						render : function(data, type, full,meta) {
							return '<div data-toggle="tooltip"  class="atip" data-placement="bottom" onMouseOver="$(this).tooltip('+"'show'"+')" data-title="'+full.operateTime+'"><span class="text-ellipsis">'+full.operateTime+'</span><div>';
						}

					},
					{
						className: "col-lg-2 datatb-max-width-devicelog",
						targets : [5],
						render : function(data, type, full,meta) {
							
							return '<div data-toggle="tooltip"  class="atip" data-placement="bottom" onMouseOver="$(this).tooltip('+"'show'"+')" data-title="'+full.operateContent+'"><span class="text-ellipsis">'+full.operateContent+'</span><div>';
						}

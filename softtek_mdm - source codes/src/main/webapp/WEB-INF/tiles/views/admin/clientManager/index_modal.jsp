...
<div class="modal fade" id="releaseClient" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
	<div class="modal-dialog" role="document">
		<div class="modal-content" style="width: 800px;height: 624px;">
			...
			<div class="modal-body" style="height:513px;overflow:auto;">
				    ...
				    <tbody>
							...
							<tr> 
								...
								<td colspan="3"><div class="pop-conlists">
									...
									<a href="javascript:void(0);" id="clientinport" class="button fa fa-arrow-circle-o-up"><fmt:message key="tiles.views.sysmanager.lisence.upload" /></a>
									</div>
							...
							<tr class="pop-item">
									...
									<div class="pop-conlists">
										<label><input type="radio" name="loginTime" id="orgNoLimit" value="" checked onclick="hideOrgList()"><fmt:message key="tiles.institution.client.manager.all.org" /></label><br>
										<label><input type="radio" name="loginTime" id="orgLimit" value="" onclick="showOrgList()"><fmt:message key="tiles.institution.client.manager.the.org" /></label>
									</div>
								</td>
							</tr>
							<tr id="orgListTr" style="display:none;">

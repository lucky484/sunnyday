...
<script>
	...
	$("#clientinport").click(function(){
		var uri = ctx+"/admin/clientManager/uploadZip?_csrf=${_csrf.token}";
	...
	$("#insert").click(function(){
		...
		var url =  ctx+"/admin/clientManager/insertClientManager?_csrf=${_csrf.token}";
		...
		var temp=$("input[name='temp']").val().trim();
		var isUpgrade = 0;
		var str = "";

						   ...
						   <div class="search-mod" style="display: none;">
						    <ul class="search-list">
			   						<li class="search-item ">
			   							...
			   							<div class="Js_dropMod select-box inline-select select-200" style="width:130px;">
											...
											<ul class="select-list" style="width:130px;">
												...
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.2" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.3" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.4" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.5" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.6" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.7" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.8" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.9" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.10" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.11" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.12" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.13" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.14" /></a></li>
												<li class="select-item"><a href="javascript:;" rel="1"><fmt:message key="tiles.views.customer.device.index.eventtype.15" /></a></li>
											</ul>
										</div>
			   						</li>
			   					</ul>
			   					<ul class="search-list" style="margin-left:98px;">
			   						<li class="search-item ">
			   							<label class="search-label" style="width:86px"><fmt:message key="tiles.institution.log.operate.device.name" />:</label>
			   							<input type="text" id="devicename" name="devicename" class="search-text" style="width:120px;">
			   						</li>
			   					</ul>
			   					<ul class="search-list" style="margin-left:98px;">
			   						<li class="search-item ">
			   							<label class="search-label" style="width:84px"><fmt:message key="tiles.views.user.index.search.username" />:</label>
             ...
             <%--               <div class="col-sm-12 search_part">
							...
							<div class="col-sm-2 searchName_val">
								<select id="eventType" class="input-sm form-control">
									...
									<option value="14"><fmt:message key="tiles.views.customer.device.index.eventtype.15" /></option>
                            ...
                            <table class="table table-striped b-t b-light" id="deviceLog">
                              <thead>
                                <tr>
                                 <th width="10%"><fmt:message key="tiles.views.user.index.search.username" /></th>
                                 <th width="15%"><fmt:message key="tiles.institution.log.operate.device.name" /></th>
                             	  <th width="15%"><fmt:message key="tiles.institution.log.operate.event.type" /></th>
                                  <th width="30%"><fmt:message key="tiles.institution.log.operate.event.content" /></th>
                                  <th width="15%"><fmt:message key="tiles.institution.log.operate.event.create.time" /></th>
                                 <th width="15%"><fmt:message key="tiles.views.netbehaviormanager.logmanager.organization.name" /></th>
                                </tr>
                              </thead>
                              <tbody>
                              </tbody>

	...
	<div class="post-item">
		<header class="panel-heading b-l-l-none b-t-l-none b-b-l-1 b-r-l-none b-s-s">
			<c:if test="${fn:length(deviceBasicInfoList) > 0}">
				...
				<a href="javascript:void(0);" class="btn btn-s-sm btn-primary" onclick="javascript:loadAppList();"><fmt:message key="tiles.views.customer.index.head.applist"/></a>
                 ...
                 <div class="panel panel-default">
                   <div class="panel-body">
                     <div class="table-responsive">
                       <table class="table table-striped b-t b-light" id="appList">
                         <thead>
                           <tr>
                             <th><fmt:message key="tiles.views.customer.appList.index.table.name"/></th>
                             <th><fmt:message key="tiles.views.customer.appList.index.table.appid"/></th>
                             <th><fmt:message key="tiles.views.customer.appList.index.table.app_version"/></th>
                             <th><fmt:message key="tiles.views.customer.appList.index.table.app_status"/></th>
                           </tr>
                         </thead>
	                         <tbody>

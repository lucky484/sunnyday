...
<spring:url value="/queryQrCode" var="queryQrCode" />
				...
				<div class="row">
					<div class="container aside-xl aside-xl-top col-sm-7 login_part">
						...
						<section class="m-b-lg">
							<header class="wrapper text-center org_manager_login ">
								<strong class=""><fmt:message
										key="jsp.manager.login.header.sub" /></strong>
							</header>
							<spring:url value="/manager/j_spring_security_check"
								...
								<div class="list-group">
									<div class="list-group-item">
										...
										<input type="text" name="j_username"
											...
											class="form-control no-border user_name" autofocus
									...
									<div class="list-group-item">
										<input type="password" name="j_password"
											...
											class="form-control no-border user_password"
									...
									<div class="list-group-item">
										<div class="form-group form-inline code_inline">
											<input id="index_code" name="validatecode"
												...
												maxlength="4" autocomplete="off" /> <img id="imgObj"
												alt="validCode" src="${validCode}" width="100px" />
										</div>
									</div>
								</div>
								<input type="submit"
					...
					<div class="org_qr_code col-sm-5 qrcode_part">
						<spring:url value="/resources/images/softtek_logo.png"
							var="logoUrl" />
						<img id="logoUrl" src="${logoUrl}"><br/>
<%-- 						<spring:url value="/resources/images/qrcode.png" var="qrcodeUrl" /> --%>
						<img id="codeimg" src="" width="140px;" height="140px;" style="margin-left: 42px;"><br/> <span
							class="code_des" style="margin-left:33px;"><fmt:message
	...
	<spring:url value="/resources/js/parsley-2.3.7/i18n/en.js"
		var="parsleyEnUrl" />

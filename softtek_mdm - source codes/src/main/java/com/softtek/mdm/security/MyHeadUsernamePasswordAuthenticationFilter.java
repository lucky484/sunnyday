...
public class MyHeadUsernamePasswordAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public MyHeadUsernamePasswordAuthenticationFilter() {

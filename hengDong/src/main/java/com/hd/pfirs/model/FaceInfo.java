...
public class FaceInfo {
	...
	public String toString() {
		return "FaceInfo [faceId=" + faceId + ", faceCode=" + faceCode + ", collectTime=" + collectTime
				...
				+ regionCode + ", collectSite=" + collectSite + ", groupCode=" + groupCode + ", collectPic="
				+ Arrays.toString(collectPic) + ", picType=" + picType + ", picNo=" + picNo + ", isLast=" + isLast
				+ ", direction=" + direction + ", speed=" + speed + ", size=" + size + ", remarkDesc=" + remarkDesc

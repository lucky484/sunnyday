package com.f2b.sugar.wxlib.menu;
...
public class MenuManager {
	...
	public static void main(String[] args) {
		// 企业Id
		String CorpID = "wxaa1cc510b33e17ea";
		// 管理组的凭证密钥，每个secret代表了对应用、通讯录、接口的不同权限；不同的管理组拥有不同的secret
		String Secret = "bUbI_vtjO3upfu_4uk51Ys6_KOuA5NlHk_FGWGrwteFIdhBPsozBQlHY6jwAT6uL";

		// 调用接口获取access_token
		AccessToken at = WeixinUtil.getAccessToken(ParamesAPI.appId, ParamesAPI.appsecret);
	...
	private static Menu getMenu() {
		...
		btn11.setName("阿克苏果");
		btn11.setType("view");
		btn11.setUrl("http://shop.hxcchn.com/F2B/web/farm/getFarmProducePage.action");
		/**
		 *

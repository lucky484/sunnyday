...
public class WXBizMsgCrypt {
     ...
     */
    public String VerifyURLForPublic(String msgSignature, String timeStamp, String nonce, String echoStr)
            throws AesException
    {
        String signature = SHA1.getSHA1ForPublic(token, timeStamp, nonce);

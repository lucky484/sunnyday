...
public class ExcelMapExport {
     ...
     * 导出Excel
     */
    public static Map<String, String> LOTTERY() {
        Map<String, String> columnPropertyMap = new LinkedHashMap<String, String>();

		columnPropertyMap.put("shopNum", "门店代码");
        columnPropertyMap.put("openid", "中奖人的openId");
		columnPropertyMap.put("lotteryDate", "抽奖时间");
        columnPropertyMap.put("lotteryType", "是否中奖");
		columnPropertyMap.put("lotteryAwards", "奖项");
        columnPropertyMap.put("prizeCode", "兑换码");

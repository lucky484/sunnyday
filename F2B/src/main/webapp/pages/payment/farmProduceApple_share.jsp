...
<body>
	<%-- <c:if test="${hint }"> 
		<div id="shareHint" class="weui_dialog_alert">
			<div class="weui_mask"></div>
			<div class="weui_dialog">
				<div class="weui_dialog_hd">
					<strong class="weui_dialog_title">温馨提示</strong>
				</div>
				<div class="weui_dialog_bd">大人，分享出去让好友购买，您也可以得到奖励哦</div>
				<div class="weui_dialog_ft">
					<a href="javascript:close()" class="weui_btn_dialog primary">朕知道了</a>
				</div>
			</div>
		</div>
	</c:if> --%>
	<div>
		<div>
			<img id="apple_reward"
				src="<c:url value="/resources/images/farmOrder/apple/webwxgetmsgimg.jpg"/>"
...
<!-- 				title="阿克苏苹果冰糖心 -- 小苹果" style="position: absolute; left: 42%; top: 57%;" /> -->
		...
		<div class="clear margin_1">
			<div class="float_l" style="width: 80%;">
				...
				<p class="margin_l3" id="appleLog" style="font-weight: 700; z-index: 2; position: relative;font-size: 32px;"> (江浙沪包邮/其他地区加20元快递费)</p>
				<div class="magrin_t1">
					<div class="font_40 margin_l3" id="">
						<div class="" id="applePrice">
							<strong class="tb-promo-price"> 
								<em class="font_40 tb-rmb text-decoration">¥ 108</em>
								<em class="tb-rmb">¥</em>
								<em id="" class="font_40 tb-rmb">93</em>
							</strong> <font style="font-weight: 100;">8.5公斤/箱</font> <span id=""
...
<!-- 						<a class="font_36 selected" id="type1" href="javascript:selectApple(0)">8.5公斤/箱</a> -->
						<a class="font_36" id="type1" href="javascript:selectApple(0)"><img alt="8.5公斤/箱" src="<c:url value="/resources/images/farmOrder/apple/guige4.jpg"/>"></a>
					</div>
...
<%--  						<img alt="2.5公斤/箱" src="<c:url value="/resources/images/farmOrder/apple/guige5.jpg"/>"> --%>
					</div>
				</span>
			</div>
			<hr class="clear hr margin_1">
...
<!-- 抽奖 -->
<%-- 		<c:if test="${orderNo ne null }"> --%>
<!-- 			<div class="clickdraw"> -->
<%-- 				<a href="<c:url value="/lottery.action?orderNo=${orderNo } "/>"> --%>
<%-- 					<img src="<c:url value="/resources/images/clickdarw.png"/>" --%>
<!-- 					alt="点击抽奖"> -->
<!-- 				</a> -->
<!-- 			</div> -->
<%-- 		</c:if> --%>
		...
		<div class="clear bottom">
			<a class="padding_lm2_1" id="buyBtn"
				href="<c:url value="/web/farm/getFarmOrderPage_share.action?type=0&openid=${openid }" />">立即购买</a>
			<a class="padding_lm2_3"
				href="<c:url value="/web/farm/getOrderList.action?type=3&openId=${openid }" />">
				查看订单</a> 
<!-- 抽奖 -->
<!-- 			<a class="padding_lm2_3" -->
<%-- 				href="<c:url value="/web/share/getShareRecord.action?shareOpenId=${openid }" />"> --%>
<!-- 				分享记录</a> -->
		</div>
	</div>
	<div style="margin-top:-20px;">
		<img data-echo="<c:url value="/resources/images/farmOrder/apple/webwxgetmsgimg_1.jpg"/>"
			style="width: 100%;" src="<c:url value="/resources/lib/lazyloading/blank.gif"/>" /> 
		<img data-echo="<c:url value="/resources/images/farmOrder/apple/webwxgetmsgimg_2.jpg"/>"
			style="width: 100%;" src="<c:url value="/resources/lib/lazyloading/blank.gif"/>" /> 
		<img data-echo="<c:url value="/resources/images/farmOrder/apple/webwxgetmsgimg_3.jpg"/>"
			style="width: 100%;" src="<c:url value="/resources/lib/lazyloading/blank.gif"/>" /> 
		<img data-echo="<c:url value="/resources/images/farmOrder/apple/webwxgetmsgimg_4.jpg"/>"
			style="width: 100%;" src="<c:url value="/resources/lib/lazyloading/blank.gif"/>" />
		<img data-echo="<c:url value="/resources/images/farmOrder/apple/webwxgetmsgimg_5.jpg"/>"
			style="width: 100%;" src="<c:url value="/resources/lib/lazyloading/blank.gif"/>" />
	</div>
	<%-- </c:forEach> --%>
...
// 				$("#type3").html("<div style='margin: 25px 0 10px 0;'>精装</div>")
				...
				$("#appleLog").html("(江浙沪包邮/其他地区加20元快递费)");
// 			} 
// 			else if (type==1) {
				//$("#appleImg").attr("src","<c:url value='/resources/images/farmOrder/apple/apple_goods.jpg'/>");
// 				$("#appleTitle").html("阿克苏苹果 圣诞组合");
// 				$("#applePrice").html("<em id='' class='font_40 tb-rmb'>¥ 45.9</em>");
...
// 				$("#type2").html("<img alt='圣诞组合' src='<c:url value="/resources/images/farmOrder/apple/guige1.jpg"/>'>")
// 				$("#type3").html("<div style='margin: 25px 0 10px 0;'>精装</div>");
// 				$("#type4").html("<div style='margin: 25px 0 10px 0;'>简装</div>")
// 				$("#appleLog").html("(全国包邮 港澳台除外)");
// 			} 
// 			else if (type==2) {
// 				//$("#appleImg").attr("src","<c:url value='/resources/images/farmOrder/apple/apple_goods.jpg'/>");
// 				$("#appleTitle").html("阿克苏苹果 精装");
// 				$("#applePrice").html("<em id='' class='font_40 tb-rmb'>¥ 29.9</em>");
...
// 				$("#type1").html("<div style='margin: 25px 0 10px 0;'>8.5公斤/箱</div>")
// 				$("#type2").html("<div style='margin: 25px 0 10px 0;'>圣诞组合</div>")
// 				$("#type3").html("<img alt='精装' src='<c:url value="/resources/images/farmOrder/apple/guige2.jpg"/>'>");
// 				$("#type4").html("<div style='margin: 25px 0 10px 0;'>简装</div>")
// 				$("#appleLog").html("(全国包邮 港澳台除外)");
			} else if (type==3) {
				//$("#appleImg").attr("src","<c:url value='/resources/images/farmOrder/apple/apple_goods.jpg'/>");
				$("#appleTitle").html("阿克苏苹果 2.5公斤/箱");
				$("#applePrice").html("<em id='' class='font_40 tb-rmb'>¥ 49.9</em>");
...
// 				$("#type2").html("<div style='margin: 25px 0 10px 0;'>圣诞组合</div>")
// 				$("#type3").html("<div style='margin: 25px 0 10px 0;'>精装</div>");
				$("#type4").html("<img alt='2.5公斤/箱' src='<c:url value="/resources/images/farmOrder/apple/guige5.jpg"/>'>");
				$("#appleLog").html("(全国包邮 港澳台除外)");
			}
		}
		function close() {

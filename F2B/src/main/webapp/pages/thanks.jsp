...
<div id="formbackground" style="position:absolute; z-index:99;height:100%; width:100%">
    <img
            src="<c:url value="/images/bg/thanks_bg.png"/>" height="100%" width="100%"/>
    <div style="top:47.5%;height:20%;text-shadow:none;position:absolute;z-index:9;text-align:center;width:100%;display:block;">
        <img src="<c:url value="/images/jd1.png"/>" id="jdquan" style="width:85%;height: 90%;">
    </div>
    <div style="top:67%;left: 12%;height:20%;text-shadow:none;position:absolute;z-index:9;width:88%;display:block;">
...
<script>
    $("#jdquan").on('click',function(){
        window.location.href = "http://coupon.m.jd.com/coupons/show.action?key=0a9efa4926554ff192fb5c904f39a4df&roleId=2604800&to=sale.jd.com/act/ghko2ryduun.html";
    });
</script>
